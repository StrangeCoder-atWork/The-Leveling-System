...
export const themes= {
	...
	default:{
	   ...
	   card:'cardSpace p-2 m-3 w-50 h-10 border-b-black border-2',
	...
	Cosmic_Ascent:{
	   ...
	   charct:"",
	   character_css:'my-10 h-full -mx-8',
	   card:'cardSpace p-2 m-3 w-40 h-10 border-b-black border-2',
	   navbar:"Nav w-full px-2 py-0 md:py-2  text-white flex items-center justify-between fixed z-50",
	   cardtype: <ItemSpace />,
	   vid:"",
	...
	Voidlight:{
	   ...
	   video:"video",
	   character_css:'my-10 h-full -mx-8',
       card:'card p-2  bg-white w-40  m-3 h-10 border-b-black border-2',
	...
	Anime:{
	   ...
	   charct:"",
	   character_css:'my-10 h-full -mx-8',
       card:'cardAnime p-2 w-35  bg-transparent  m-3 h-10 border-b-black border-2',
	...
	Peace:{
	   ...
	   charct:"",
	   character_css:'my-10 h-full -mx-8',
       card:'cardPeace p-2  bg-transparent   m-3 h-10 border-b-black border-2',
	...
	Nostalgic:{
	   ...
	   charct:"",
	   character_css:'my-10 h-full -mx-8',
       card:'cardJapan p-2  bg-transparent   m-3 h-10 border-b-black border-2',
	...
	Quantum_Threads:{
	   ...
	   charct:"",
	   character_css:'my-10 h-full -mx-8',
       card:'cardTech p-2  bg-transparent   m-3 h-10 border-b-black border-2',
	...
	Legacy_Knight:{
	   ...
	   charct:"",
	   character_css:'my-10 h-full -mx-8',
       card:'cardClassic p-2  bg-transparent   m-3 h-10 border-b-black border-2',
	...
	Mythical:{
       ...
       card:'cardMythical p-2  bg-transparent   m-3 h-10 border-b-black border-2',
	...
	The_Last_Flame:{
	   ...
	   charct:"",
	   character_css:'my-10 h-full -mx-8',
       card:'cardAshes p-2  bg-transparent   m-3 h-10 border-b-black border-2',
